...
def steal_collection(collection_url: str,collection_name,scraping_range_start,scraping_range_end):
    links = []
    json_list = []
    scrapped_json = []
    image_list = []
    ...
    #i = int(token_id)
    i= int(scraping_range_start)
    #Get 5 NFTs
    while i < int(scraping_range_end)+1:#int(token_id)+5:
        if ext != None:
